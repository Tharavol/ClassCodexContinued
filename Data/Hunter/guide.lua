  ...
  ["beast-mastery"] = {
    ...
    talents = {
      ...
      },
      {
        heroTalent = "Pack Leader",
        context = "Mythic+",
        exportString = "C0PAAAAAAAAAAAAAAAAAAAAAAAMmxwCsBzwQDbAAYGPwyMzsYGmZmZGzMMzMmhZGzMzYbmZYMDLDNDAAAAAAAAYegxMDYmNEwsA2GA",
      },
      {
        heroTalent = "Dark Ranger",
        context = "Mythic+",
    ...
    rotation = {
      {
        ...
        context = "Single Target",
        steps = {
          "Trinket Usage We usually want to pair stat-granting on-use trinkets with {288613}. should be used shortly before {288613}; avoid spending time casting it after Trueshot has already been popped. Ideally, pair it with {257044} as in the opener.",
