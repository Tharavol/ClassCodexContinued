...
L["bis.help.archon"] = "Archon montre l'équipement que les meilleurs joueurs utilisent réellement en Mythique+ et en raid cette saison — basé sur la popularité, pas une liste Best in Slot organisée."
L["bis.help.archon_mplus"] = "Les données Mythique+ proviennent des hautes clés."
...
L["about.source_role.wowhead"] = "Guides et BiS"
L["about.source_role.icyveins"] = "BiS et talents"
L["about.source_role.archon"] = "Builds méta"
L["about.source_role.murlok"] = "Équipement JcJ"
...
L["settings.tooltip.wowhead_bis"] = "Affiche les spécialisations pour lesquelles un objet est Best in Slot dans les infobulles (Wowhead)."
...
L["settings.tooltip.dock_show_stat_targets"] = "Affiche la section « Objectifs de stats » (barres en direct comparées aux objectifs empiriques d'Archon) dans l'onglet Stats lorsque le panneau est ancré."
L["settings.tooltip.float_show_stat_targets"] = "Affiche la section « Objectifs de stats » (barres en direct comparées aux objectifs empiriques d'Archon) dans l'onglet Stats lorsque le panneau est flottant."
...
L["settings.tooltip.source_display"] = "Comment afficher les sources de données (Wowhead, Icy Veins) dans les infobulles d'objets."
...
L["loadout_dock.no_archon_builds"] = "Aucun build Archon disponible."
...
L["settings.label.dock_show_wowhead"] = "Afficher les recommandations Wowhead dans le menu"
L["settings.label.dock_show_archon"] = "Afficher les recommandations Archon dans le menu"
L["settings.tooltip.dock_show_saved"] = "Inclut vos configurations de talents Blizzard enregistrées dans le menu du dock."
L["settings.tooltip.dock_show_wowhead"] = "Inclut les builds recommandés issus de Wowhead dans le menu du dock."
L["settings.tooltip.dock_show_archon"] = "Inclut les builds Archon recommandés par rencontre dans le menu du dock."
...
L["pvp.no_stat_targets"] = "Aucun objectif de stat JcJ pour cette spécialisation pour l'instant."
...
L["footer.data_refresh_hint"] = "Les données sont mises à jour chaque semaine. Mettez à jour Class Codex pour obtenir les dernières informations."
L["tab.crafting"] = "Artisanat"
L["crafting.section_crafts"] = "Objets crafted"
L["crafting.section_embellishments"] = "Embellissements"
L["crafting.no_data"] = "Pas encore de données d artisanat — mise à jour hebdomadaire."
L["crafting.menu.track_materials"] = "Suivre les matériaux"
L["crafting.menu.wowhead"] = "Ouvrir dans Wowhead"
L["crafting.help.intro"] = "Objets d artisanat recommandés pour cette spécialisation."
L["crafting.help.star"] = "Choix optimal selon Wowhead."
L["crafting.help.check"] = "Possédé — sacs, banque, équipé ou appliqué comme embellissement."
L["crafting.help.popular_archon"] = "Populaire sur Archon — les 2 choix les plus joués dans l'échantillon PvE des meilleurs joueurs d'Archon."
L["crafting.help.popular_murlok"] = "Populaire sur Murlok — les 2 choix les plus joués dans l'échantillon PvP des meilleurs joueurs de Murlok."
L["crafting.help.menu"] = "Clic droit sur un objet pour suivre les matériaux ou copier un lien Wowhead."
...
L["crafting.tooltip.popular_archon"] = "Populaire sur Archon"
L["crafting.tooltip.popular_murlok"] = "Populaire sur Murlok"
...
L["settings.tooltip.crafting_top_picks_only"] = "Masque les entrées en bas de l'onglet artisanat — affiche uniquement les BiS Wowhead et les choix les plus joués."
