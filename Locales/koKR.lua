...
L["bis.help.archon"] = "Archon은 이번 시즌 상위 플레이어가 신화+와 레이드에서 실제로 사용하는 장비를 보여줍니다 — 인기도 기반이며, 선별된 최적 장비 목록이 아닙니다."
L["bis.help.archon_mplus"] = "신화+ 데이터는 높은 단계 쐐기돌 기록을 기반으로 합니다."
L["tab.about"] = "정보"
...
L["about.source_role.wowhead"] = "공략 & BiS"
L["about.source_role.icyveins"] = "BiS & 특성"
L["about.source_role.archon"] = "메타 빌드"
L["about.source_role.murlok"] = "PvP 장비"
...
L["settings.tooltip.wowhead_bis"] = "아이템 툴팁에 해당 아이템이 최적 장비인 전문화를 표시합니다 (Wowhead)."
...
L["settings.tooltip.dock_show_stat_targets"] = "패널이 도킹되었을 때 능력치 탭에 능력치 목표 섹션(실시간 바 vs Archon 통계 목표)을 표시합니다."
L["settings.tooltip.float_show_stat_targets"] = "패널이 떠 있을 때 능력치 탭에 능력치 목표 섹션(실시간 바 vs Archon 통계 목표)을 표시합니다."
...
L["settings.tooltip.source_display"] = "아이템 툴팁에 데이터 출처(Wowhead, Icy Veins)를 표시하는 방식."
...
L["loadout_dock.no_archon_builds"] = "사용 가능한 Archon 빌드 없음."
...
L["settings.label.dock_show_wowhead"] = "메뉴에 Wowhead 추천 표시"
L["settings.label.dock_show_archon"] = "메뉴에 Archon 추천 표시"
L["settings.tooltip.dock_show_saved"] = "도크의 클릭 메뉴에 블리자드 저장 특성 로드아웃을 포함합니다."
L["settings.tooltip.dock_show_wowhead"] = "도크의 클릭 메뉴에 Wowhead 출처 추천 빌드를 포함합니다."
L["settings.tooltip.dock_show_archon"] = "도크의 클릭 메뉴에 Archon의 보스별 추천 빌드를 포함합니다."
...
L["pvp.no_stat_targets"] = "이 전문화에 대한 PvP 능력치 목표가 아직 없습니다."
...
L["footer.data_refresh_hint"] = "데이터는 매주 갱신됩니다. Class Codex를 업데이트하여 최신 정보를 받으세요."
L["tab.crafting"] = "제작"
L["crafting.section_crafts"] = "제작품"
L["crafting.section_embellishments"] = "장식"
L["crafting.no_data"] = "제작 데이터 없음 — 매주 갱신됩니다."
L["crafting.menu.track_materials"] = "재료 추적"
L["crafting.menu.wowhead"] = "Wowhead에서 열기"
L["crafting.help.intro"] = "이 전문화의 추천 제작품."
L["crafting.help.star"] = "Wowhead 최고 선택."
L["crafting.help.check"] = "보유 중 — 가방, 은행, 장착 또는 장식으로 적용됨."
L["crafting.help.popular_archon"] = "Archon에서 인기 — Archon의 PvE 상위 플레이어 표본에서 가장 많이 사용된 상위 2개 선택."
L["crafting.help.popular_murlok"] = "Murlok에서 인기 — Murlok의 PvP 상위 플레이어 표본에서 가장 많이 사용된 상위 2개 선택."
L["crafting.help.menu"] = "아이템을 우클릭하여 재료를 추적하거나 Wowhead 링크를 복사하세요."
L["crafting.help.embellishment_limit"] = "필요한 만큼 제작하세요 — 다만 캐릭터당 장식은 2개까지만 장착할 수 있습니다."
L["crafting.tooltip.bis"] = "최고 선택."
L["crafting.tooltip.popular_archon"] = "Archon에서 인기"
L["crafting.tooltip.popular_murlok"] = "Murlok에서 인기"
...
L["settings.tooltip.crafting_top_picks_only"] = "제작 탭의 후순위 항목 숨기기 — Wowhead BiS와 가장 많이 사용되는 선택만 표시합니다."
