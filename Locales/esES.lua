...
L["bis.help.archon"] = "Archon muestra el equipo que los mejores jugadores usan realmente en Mítica+ y banda esta temporada — basado en popularidad, no una lista Best in Slot curada."
L["bis.help.archon_mplus"] = "Los datos de Mítica+ provienen de llaves altas."
...
L["empty.no_builds_details"] = "No hay builds disponibles — consulta Wowhead para más detalles."
L["empty.no_builds_for"] = "No hay builds para %s — consulta Wowhead."
L["empty.no_rotation_for_details"] = "No hay rotación para %s — consulta Wowhead para más detalles."
L["empty.no_rotation_for"] = "No hay rotación para %s — consulta Wowhead."
...
L["about.data_sources"] = "Fuentes de datos"
L["about.source_role.wowhead"] = "Guías y BiS"
L["about.source_role.icyveins"] = "BiS y talentos"
L["about.source_role.archon"] = "Builds meta"
L["about.source_role.murlok"] = "Equipo PvP"
...
L["settings.label.wowhead_bis"] = "Info BiS Wowhead en descripciones"
...
L["settings.tooltip.wowhead_bis"] = "Muestra para qué especializaciones un objeto es mejor equipo en las descripciones (Wowhead)."
...
L["settings.tooltip.dock_show_stat_targets"] = "Muestra la sección Objetivos de Atributos (barras en vivo frente a los objetivos empíricos de Archon) en la pestaña de Atributos cuando el panel está acoplado."
L["settings.tooltip.float_show_stat_targets"] = "Muestra la sección Objetivos de Atributos (barras en vivo frente a los objetivos empíricos de Archon) en la pestaña de Atributos cuando el panel está flotante."
...
L["settings.tooltip.source_display"] = "Cómo mostrar las fuentes de datos (Wowhead, Icy Veins) en las descripciones de objetos."
...
L["loadout_dock.no_archon_builds"] = "No hay builds de Archon disponibles."
...
L["settings.label.dock_show_wowhead"] = "Mostrar recomendaciones de Wowhead en el menú"
L["settings.label.dock_show_archon"] = "Mostrar recomendaciones de Archon en el menú"
L["settings.tooltip.dock_show_saved"] = "Incluye tus configuraciones de talentos guardadas de Blizzard en el menú del dique."
L["settings.tooltip.dock_show_wowhead"] = "Incluye los builds recomendados de Wowhead en el menú del dique."
L["settings.tooltip.dock_show_archon"] = "Incluye los builds recomendados por encuentro de Archon en el menú del dique."
...
L["pvp.no_stat_targets"] = "Aún no hay objetivos de atributos JcJ para esta especialización."
...
L["footer.data_refresh_hint"] = "Los datos se actualizan semanalmente. Actualiza Class Codex para obtener las últimas novedades."
L["tab.crafting"] = "Artesanía"
L["crafting.section_crafts"] = "Objetos artesanos"
L["crafting.section_embellishments"] = "Engalanados"
L["crafting.no_data"] = "Sin datos de artesanía aún — actualizados semanalmente."
L["crafting.menu.track_materials"] = "Seguir materiales"
L["crafting.menu.wowhead"] = "Abrir en Wowhead"
L["crafting.help.intro"] = "Artesanías recomendadas para esta especialización."
L["crafting.help.star"] = "Elección óptima de Wowhead."
L["crafting.help.check"] = "Lo tienes — en bolsas, banco, equipado o aplicado como engalanado."
L["crafting.help.popular_archon"] = "Popular en Archon — las 2 elecciones más jugadas en la muestra PvE de top players de Archon."
L["crafting.help.popular_murlok"] = "Popular en Murlok — las 2 elecciones más jugadas en la muestra PvP de top players de Murlok."
L["crafting.help.menu"] = "Clic derecho en cualquier objeto para seguir materiales o copiar un enlace de Wowhead."
...
L["crafting.tooltip.popular_archon"] = "Popular en Archon"
L["crafting.tooltip.popular_murlok"] = "Popular en Murlok"
...
L["settings.tooltip.crafting_top_picks_only"] = "Oculta las entradas finales en la pestaña de artesanía — muestra solo el BiS de Wowhead y las elecciones más jugadas."
